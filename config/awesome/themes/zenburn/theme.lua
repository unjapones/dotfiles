...
-- {{{ Main
theme = {}
theme.wallpaper_cmd = { "awsetbg -a /home/japones/.config/awesome/themes/zenburn/walls/defaultwall" }
...
-- {{{ Misc
--theme.awesome_icon           = "/home/japones/.config/awesome/themes/zenburn/awesome-icon.png"
